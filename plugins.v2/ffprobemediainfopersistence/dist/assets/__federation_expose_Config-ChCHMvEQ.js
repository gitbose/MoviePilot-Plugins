          ...
          _createVNode(_component_v_col, {
            ...
            default: _withCtx(() => [
              _createVNode(_component_v_switch, {
                ...
                "onUpdate:modelValue": _cache[1] || (_cache[1] = $event => ((config.value.cleanup_moved_source_json) = $event)),
            ...
            _createVNode(_component_v_col, {
              ...
              default: _withCtx(() => [
                _createVNode(_component_v_switch, {
                  ...
                  "onUpdate:modelValue": _cache[2] || (_cache[2] = $event => ((config.value.fallback_probe) = $event)),
                  label: "上游缓存缺失时主动提取",
            ...
            _createVNode(_component_v_col, {
              ...
              default: _withCtx(() => [
                _createVNode(_component_v_switch, {
                  ...
                  "onUpdate:modelValue": _cache[3] || (_cache[3] = $event => ((config.value.overwrite_json) = $event)),
                  label: "覆盖同名 JSON",
            ...
            _createVNode(_component_v_col, {
              ...
              default: _withCtx(() => [
                _createVNode(_component_v_switch, {
                  ...
                  "onUpdate:modelValue": _cache[4] || (_cache[4] = $event => ((config.value.allow_abnormal_size_json) = $event)),
                  label: "生成异常大小 JSON",
            ...
            _createVNode(_component_v_col, {
              ...
              default: _withCtx(() => [
                _createVNode(_component_v_text_field, {
                  ...
                  "onUpdate:modelValue": _cache[5] || (_cache[5] = $event => ((config.value.fallback_workers) = $event)),
            ...
            _createVNode(_component_v_col, {
              ...
              default: _withCtx(() => [
                _createVNode(_component_v_text_field, {
                  ...
                  "onUpdate:modelValue": _cache[6] || (_cache[6] = $event => ((config.value.fallback_timeout) = $event)),
                  modelModifiers: { number: true },
                  label: "主动提取超时（秒）",
                  type: "number",
                  min: "1",
            ...
            _createVNode(_component_v_col, {
              ...
              default: _withCtx(() => [
                _createVNode(_component_v_select, {
                  ...
                  "onUpdate:modelValue": _cache[7] || (_cache[7] = $event => ((config.value.filter_match_mode) = $event)),
                  label: "生成 JSON 匹配条件",
            ...
            _createVNode(_component_v_col, { cols: "12" }, {
              default: _withCtx(() => [
                _createVNode(_component_v_textarea, {
                  ...
                  "onUpdate:modelValue": _cache[8] || (_cache[8] = $event => ((config.value.transfer_methods) = $event)),
            ...
            _createVNode(_component_v_col, { cols: "12" }, {
              default: _withCtx(() => [
                _createVNode(_component_v_textarea, {
                  ...
                  "onUpdate:modelValue": _cache[9] || (_cache[9] = $event => ((config.value.destination_roots) = $event)),
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-938cf401"]]);
