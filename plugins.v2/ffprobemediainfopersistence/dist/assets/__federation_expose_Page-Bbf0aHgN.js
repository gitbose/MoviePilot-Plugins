...
const {resolveComponent:_resolveComponent,createVNode:_createVNode,renderList:_renderList,Fragment:_Fragment,openBlock:_openBlock,createElementBlock:_createElementBlock,toDisplayString:_toDisplayString,createTextVNode:_createTextVNode,withCtx:_withCtx,createBlock:_createBlock,createElementVNode:_createElementVNode,createCommentVNode:_createCommentVNode,withKeys:_withKeys} = await importShared('vue');


const _hoisted_1 = { class: "d-flex flex-wrap align-center ga-2 mb-1" };
const _hoisted_2 = { class: "d-flex flex-wrap ga-2" };
const _hoisted_3 = { class: "d-flex flex-wrap ga-2 mb-1" };
const _hoisted_4 = { class: "d-flex flex-wrap align-center ga-2 mb-2" };
const _hoisted_5 = { class: "text-body-2" };
const _hoisted_6 = { class: "path-cell" };
const _hoisted_7 = { class: "records-pagination d-flex flex-wrap align-center ga-2 mt-2" };
...
async function submitSelected(action) {
  ...
  try {
    ...
    // 重新提取的真实状态由右侧进度栏呈现，不再额外显示“已提交”成功提示。
    if (action === 'retry') {
      notice.value = '';
    } else {
      notice.value = result.message || '已删除插件记录';
...
return (_ctx, _cache) => {
  ...
  return (_openBlock(), _createElementBlock("div", {
    ...
    _createElementVNode("div", _hoisted_4, [
      _createElementVNode("span", _hoisted_5, "已选 " + _toDisplayString(selectedCount.value) + " 项", 1),
      _createVNode(_component_v_btn, {
        color: "primary",
        size: "small",
        disabled: !selectedCount.value || actionRunning.value || retryRunning.value,
        onClick: _cache[3] || (_cache[3] = $event => (submitSelected('retry')))
      }, {
          ...
          default: _withCtx(() => [
            _createElementVNode("thead", null, [
              _createElementVNode("tr", null, [
                ...
                _cache[19] || (_cache[19] = _createElementVNode("th", null, "首次记录时间", -1)),
                _cache[20] || (_cache[20] = _createElementVNode("th", null, "失败原因 / 大小信息", -1)),
                _cache[21] || (_cache[21] = _createElementVNode("th", null, "尝试次数", -1)),
                _cache[22] || (_cache[22] = _createElementVNode("th", null, "目标文件", -1))
              ])
            ]),
            _createElementVNode("tbody", null, [
              (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(rows.value, (row) => {
                return (_openBlock(), _createElementBlock("tr", {
                  ...
                  _createElementVNode("td", _hoisted_6, _toDisplayString(row.destination || '-'), 1)
                ]))
              }), 128))
            ])
          ]),
    ...
    _createElementVNode("div", _hoisted_7, [
      _createElementVNode("span", _hoisted_8, "共 " + _toDisplayString(total.value) + " 条，每页", 1),
      _createVNode(_component_v_select, {
        modelValue: pageSize.value,
        "onUpdate:modelValue": [
          _cache[4] || (_cache[4] = $event => ((pageSize).value = $event)),
          _cache[5] || (_cache[5] = $event => (loadPage({ resetPage: true })))
        ],
        class: "page-size",
        density: "compact",
        "hide-details": "",
      ...
      _createVNode(_component_v_btn, {
        ...
        onClick: _cache[7] || (_cache[7] = $event => (switchPage(page.value + 1)))
      }, {
      ...
      _createVNode(_component_v_text_field, {
        ...
        "onUpdate:modelValue": _cache[8] || (_cache[8] = $event => ((requestedPage).value = $event)),
        class: "goto-page",
        density: "compact",
        "hide-details": "",
        "aria-label": "前往页码",
...
const Page = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-679df4b1"]]);
