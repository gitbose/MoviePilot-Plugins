...
const _hoisted_1 = { class: "d-flex flex-wrap ga-2 mb-3" };
const _hoisted_2 = { class: "d-flex flex-wrap ga-2 mb-3" };
const _hoisted_3 = { class: "d-flex flex-wrap align-center ga-2 mb-3" };
const _hoisted_4 = { class: "text-body-2" };
const _hoisted_5 = {
  key: 0,
  class: "text-caption"
};
const _hoisted_6 = { class: "d-flex flex-wrap align-center ga-2 mb-4" };
const _hoisted_7 = { class: "text-body-2" };
const _hoisted_8 = { class: "path-cell" };
...
const statusTabs = computed(() => [
  ...
  { key: 'handled', label: '已处理', count: counts.value.handled || 0 },
  { key: 'abnormal_size', label: '异常大小已生成', count: counts.value.abnormal_size || 0 },
  { key: 'abnormal_size_pending', label: '异常大小未生成', count: counts.value.abnormal_size_pending || 0 },
]);
  ...
  return (_openBlock(), _createElementBlock("div", {
    ...
    _createElementVNode("div", _hoisted_1, [
      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(statusTabs.value, (item) => {
        return (_openBlock(), _createBlock(_component_v_btn, {
          ...
          color: state.value === item.key ? 'primary' : undefined,
    ...
    _createElementVNode("div", _hoisted_2, [
      _createVNode(_component_v_btn, {
        ...
        color: reason.value ? undefined : 'primary',
        onClick: _cache[0] || (_cache[0] = $event => (switchReason('')))
      }, {
      ...
      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(reasons.value, (item) => {
        return (_openBlock(), _createBlock(_component_v_btn, {
          ...
          color: reason.value === item ? 'primary' : undefined,
    ...
    _createElementVNode("div", _hoisted_3, [
      _createElementVNode("span", _hoisted_4, "共 " + _toDisplayString(total.value) + " 条，当前第 " + _toDisplayString(page.value) + " / " + _toDisplayString(pageCount.value) + " 页", 1),
      _createVNode(_component_v_select, {
        modelValue: pageSize.value,
        "onUpdate:modelValue": [
          _cache[1] || (_cache[1] = $event => ((pageSize).value = $event)),
          _cache[2] || (_cache[2] = $event => (loadPage({ resetPage: true })))
        ],
        class: "page-size",
        density: "compact",
        "hide-details": "",
      ...
      _createVNode(_component_v_btn, {
        ...
        onClick: _cache[3] || (_cache[3] = $event => (switchPage(page.value - 1)))
      }, {
      ...
      _createVNode(_component_v_btn, {
        ...
        onClick: _cache[4] || (_cache[4] = $event => (switchPage(page.value + 1)))
      }, {
      ...
      _createVNode(_component_v_text_field, {
        ...
        "onUpdate:modelValue": _cache[5] || (_cache[5] = $event => ((requestedPage).value = $event)),
        class: "goto-page",
        density: "compact",
        "hide-details": "",
        label: "前往页码",
    ...
    _createElementVNode("div", _hoisted_6, [
      _createElementVNode("span", _hoisted_7, "已选 " + _toDisplayString(selectedCount.value) + " 项", 1),
      _createVNode(_component_v_btn, {
        color: "primary",
        size: "small",
        disabled: !selectedCount.value || actionRunning.value || retryRunning.value,
        onClick: _cache[6] || (_cache[6] = $event => (submitSelected('retry')))
      }, {
          ...
          default: _withCtx(() => [
            _createElementVNode("thead", null, [
              _createElementVNode("tr", null, [
                ...
                _cache[18] || (_cache[18] = _createElementVNode("th", null, "首次记录时间", -1)),
                _cache[19] || (_cache[19] = _createElementVNode("th", null, "失败原因 / 大小信息", -1)),
                _cache[20] || (_cache[20] = _createElementVNode("th", null, "尝试次数", -1)),
                _cache[21] || (_cache[21] = _createElementVNode("th", null, "目标文件", -1))
              ])
            ]),
            _createElementVNode("tbody", null, [
              (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(rows.value, (row) => {
                return (_openBlock(), _createElementBlock("tr", {
                  ...
                  _createElementVNode("td", _hoisted_8, _toDisplayString(row.destination || '-'), 1)
                ]))
              }), 128))
            ])
          ]),
...
const Page = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-43f8e7b3"]]);
