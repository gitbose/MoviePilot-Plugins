...
<template>
  <div ref="configRoot" class="ffprobe-config plugin-root">
    <div class="plugin-page-title">ffprobe媒体信息持久化</div>
...
.plugin-page-title { position: absolute; top: 16px; left: 24px; font-size: 1.125rem; font-weight: 600; line-height: 1.5rem; }
...
@media (max-width: 600px) {
  ...
  .plugin-page-title { top: 12px; left: 16px; }
}
</style>
