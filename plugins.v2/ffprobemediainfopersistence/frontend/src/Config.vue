...
<style scoped>
.ffprobe-config { box-sizing: border-box; display: flex; flex-direction: column; position: relative; height: min(88vh, 60rem); overflow: hidden; padding: 20px 72px 24px 24px; }
...
@media (max-width: 600px) {
  .ffprobe-config { padding: 16px 56px 16px 16px; }
}
</style>
