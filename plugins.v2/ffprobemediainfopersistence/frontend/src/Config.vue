...
<style scoped>
.ffprobe-config { box-sizing: border-box; display: flex; flex-direction: column; position: relative; height: min(88vh, 60rem); overflow: hidden; padding: 20px 24px 24px; }
