...
<template>
  <div ref="pageRoot" class="ffprobe-records plugin-root">
    ...
    <div class="records-pagination d-flex flex-wrap align-center ga-2 mt-3">
...
<style scoped>
.ffprobe-records { box-sizing: border-box; display: flex; flex-direction: column; position: relative; height: min(calc(100vh - 48px), 62.5rem); min-width: 0; overflow: hidden; padding: 20px 24px 24px; }
