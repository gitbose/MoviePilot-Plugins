  ...
  <div class="ffprobe-records plugin-root">
    ...
    <div class="d-flex flex-wrap ga-2 mb-3">
      <v-btn
        ...
        :color="state === item.key ? 'primary' : undefined"
    ...
    <div class="d-flex flex-wrap ga-2 mb-3">
      <v-btn size="x-small" :variant="reason ? 'text' : 'tonal'" :color="reason ? undefined : 'primary'" @click="switchReason('')">全部原因</v-btn>
      <v-btn
        v-for="item in reasons"
        :key="item"
        size="x-small"
        :variant="reason === item ? 'tonal' : 'text'"
        :color="reason === item ? 'primary' : undefined"
