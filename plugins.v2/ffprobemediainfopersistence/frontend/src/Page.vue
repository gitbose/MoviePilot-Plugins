...
<template>
  <div ref="pageRoot" class="ffprobe-records plugin-root">
    ...
    <div class="d-flex flex-wrap align-center ga-2 mb-3">
      ...
      <v-spacer />
      <v-btn size="small" color="warning" variant="tonal" prepend-icon="mdi-information-outline" @click="helpDialog = true">使用说明</v-btn>
    </div>
...
<style scoped>
.ffprobe-records { box-sizing: border-box; display: flex; flex-direction: column; position: relative; height: min(88vh, 60rem); min-width: 0; overflow: hidden; padding: 20px 72px 24px 24px; }
...
@media (max-width: 600px) {
  .ffprobe-records { padding: 16px 56px 16px 16px; }
}
</style>
