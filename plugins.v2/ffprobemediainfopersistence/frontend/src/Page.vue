...
<style scoped>
.ffprobe-records { box-sizing: border-box; display: flex; flex-direction: column; position: relative; height: min(calc(100vh - 40px), 62.5rem); min-width: 0; overflow: hidden; padding: 20px 24px 24px; }
